        ...
        if ($data) {
            ...
            if ($view === 'all_together_in_table') {
                foreach ($data['value'] as $key => $single_data) {
                    $structure .= '<tr class="wpview_date_field">';
                ...
                $structure .= '<div class="wpview_column wpview_date_view">';
                foreach ($data['value'] as $key => $single_data) {
                    $structure .= '<div class="wpview_date">';
                ...
                $structure .= '<div class="wpview_date_view">';
